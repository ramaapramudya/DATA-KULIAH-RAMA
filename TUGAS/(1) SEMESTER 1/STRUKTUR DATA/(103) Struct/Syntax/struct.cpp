...
int main()
{
    struct Ipk fauzi, rama;
    {
        ...
        rama.matkul03 = "Alpro 1";
        rama.matkul04 = "Pengantar ICT";
        rama.matkul05 = "Bahasa Inggirs";
    ...
    cout << "Mata Kuliah yang di tempuh :  " << endl;
    cout << fixed;
